...
var listProxy = [
  { path: "/id-ctn", proxy: "103.133.223.50" },
  { path: "/id-pm", proxy: "103.6.207.108" },
  { path: "/id-gcp", proxy: "35.219.15.90" },
  { path: "/id-herza", proxy: "103.168.146.169" },
  { path: "/id-akamai", proxy: "172.232.239.151" },
  { path: "/id-alibaba", proxy: "8.215.25.225" },
  { path: "/id-tencent", proxy: "43.133.145.156" },
  { path: "/id-chi", proxy: "103.186.1.209" },
  { path: "/sg-do", proxy: "188.166.255.195" },
  { path: "/sg-ovh", proxy: "15.235.162.49" },
  { path: "/sg-vultr", proxy: "45.77.36.40" },
  { path: "/sg-oracle", proxy: "129.150.50.63" },
  { path: "/sg-htz", proxy: "5.223.41.42" },
  { path: "/sg-alibaba", proxy: "8.222.250.88" },
  { path: "/sg-akamai", proxy: "139.177.190.120" }
  //tambahin sendiri
];
var proxyIP;
var worker_default = {
...
<head>
    ...
    <title>Vless | Odierbambi | CLoudFlare</title>
